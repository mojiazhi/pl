 ...
 */
package com.pl.tool.web.common.impl;
...
/**
 * @author george.mo
 * @version $Id: MyCaptchaEngineImpl.java, v 0.1 2017/10/28 下午11:46 george.mo Exp $
 */
public class MyCaptchaEngineImpl extends ImageCaptchaEngine implements CaptchaEngine {

    protected static final Log logger = LogFactory.getLog(MyCaptchaEngineImpl.class);
    ...
    public void initialFactories() {
        ...
        java.util.List<ImageDeformation> textDef = new ArrayList<>();
